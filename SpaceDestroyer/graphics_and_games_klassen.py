...
@author: Klaus Reinold & Philipp Winter
"""
...
class WUERFEL:
    """
    Wrapperklasse zur Beschreibung eines Würfels
    """

    def __init__(self, x = 10, y = 10, groesse = 60, farbe = "weiß", sichtbar = True):
    ...
    def AugenLoeschen(self):
        for auge in self.augen:
            auge.Entfernen()

        self.augen = []


    def AugenAnzeigen(self):

        self.AugenLoeschen()

        links = self.groesse * 0.25
        mitte = self.groesse * 0.5
        rechts = self.groesse * 0.75

        oben = self.groesse * 0.25
        zentrum = self.groesse * 0.5
        unten = self.groesse * 0.75
        ...
        for posX, posY in muster[self.augenzahl]:
            radius = self.groesse // 12
    ...
    def PositionSetzen(self, x, y):
        ...
        self.quadrat.PositionSetzen(x, y)
    ...
    def FarbeSetzen(self, farbe):
        ...
        self.quadrat.FarbeSetzen(farbe)
    ...
    def SichtbarkeitSetzen(self, sichtbar):
        ...
        self.quadrat.SichtbarkeitSetzen(sichtbar)

        for auge in self.augen:
            auge.SichtbarkeitSetzen(sichtbar)


    def Entfernen(self):

        self.quadrat.Entfernen()
    ...
    def GroesseSetzen(self, groesse):
        ...
        -- Parameter groesse neue Größe
        """

        self.groesse = groesse

        self.quadrat.GroesseSetzen(groesse, groesse)
...
class EINGABE(EREIGNISBEHANDLUNG):
    """
    Klasse für Texteingaben über die Tastatur
    """

    def __init__(self, x = 10, y = 10, breite = 200,
                 textgroesse = 20,
                 farbe = "schwarz",
                 hintergrund = "weiss"):
        ...
        self.anzeige.TextSetzen(self.text)
    ...
    def PositionSetzen(self, x, y):
        ...
        self.rahmen.PositionSetzen(x, y)
        self.anzeige.PositionSetzen(x + 5, y + 2)


    def FarbeSetzen(self, farbe):

        self.anzeige.FarbeSetzen(farbe)


    def HintergrundfarbeSetzen(self, farbe):

        self.rahmen.FarbeSetzen(farbe)


    def Entfernen(self):

        self.rahmen.Entfernen()
        self.anzeige.Entfernen()
